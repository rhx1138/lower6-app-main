							...
							<tr>
								...
								<td>  Select Time:
									<div class="input-group bootstrap-timepicker timepicker">
										<input id="timepicker1" type="text" class="form-control input-small" style="width:145px;" onclick="myClick()">
										<!--<span class="input-group-addon"><i class="glyphicon glyphicon-time"></i></span>-->
									</div>
								</td>
								<td style="width:13%;">&nbsp;&nbsp;
								
								<input type="button" onclick="update_data();" name="Submit_search" id="Submit_search" value="Save" style="float: left; margin-right: 20px;">
...
var databaseRef1 = firebase.database().ref('settings/-L3cKXp56sBGsfGk6_0p');
	...
	databaseRef1.once('value', function(childSnapshot1) {
		...
		document.getElementById("timepicker1").value = childData1.time;
	});
